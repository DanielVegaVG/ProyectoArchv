...
////
INSERT INTO Alumnos (puesto, nombre, contrasena, jesuita,  frase, imagen, nombreWeb, usuario ) 
VALUES 
...
CREATE TABLE Agradecimientos (
    ...
    CONSTRAINT idEmisor FOREIGN KEY (idEmisor) REFERENCES Alumnos(puesto),
    CONSTRAINT idReceptor FOREIGN KEY (idReceptor) REFERENCES Alumnos(puesto)
);